  ...
  <div class="container max-w-screen-xl mx-auto px-4">
      ...
      <div class="lg:flex flex-col md:flex-row text-center lg:text-left lg:justify-between">
          <div class="mb-10 lg:mb-0">
              <img src="{{asset('assets-internal/mosque.png')}}" alt="Image" class="mb-5 mx-auto lg:mx-0">
      ...
      <p class="font-normal text-gray-400 text-md text-center mt-5">© 2021 Digital Agency. All rights reserved.</p>
