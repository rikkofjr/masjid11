                    ...
                    <div class="items-center py-3">
                        ...
                        <div class="mt-9 row setup-content {{ $currentStep != 1 ? 'displayNone' : '' }}" id="step-1">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="form-group">
                                        <label for="large-input" class="mb-5 text-lg font-medium text-gray-900 dark:text-white">Nominal Uang infaq</label>
                                        <input type="text" value="35000" id="uang_infaq" wire:model="uang_perjiwa" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div class="mt-9 setup-content {{ $currentStep != 2 ? 'displayNone' : '' }}" id="step-2">
                            ...
                            <div class="mb-5">
                                ...
                                <!--ambil nilai zakat fitrah -->
                                        ...
                                        <h5>Masukan nominaal uang</h5>
                                        <div class="">
                                            <label for="large-input" class="mb-5 text-lg font-medium text-gray-900 dark:text-white">Nominal Uang</label>
                                            <input type="text" id="uang_zakat" wire:model="uang_perjiwa" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                        </div>
                        ...
                        <div class="mt-9 setup-content" id="step-3">
                        ...
                        <div class="mt-9 setup-content {{ $currentStep != 4 ? 'displayNone' : '' }}" id="step-4">
                            <div class="mb-5 grid-cols-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Hanya tulis angka" wire:model="uang_infaq" id="uang_infaq" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
